"""``autosampler preview`` — render a small subset of an instrument, for a quick listen.
...
from autosampler.pipeline.executor import PipelineError, load_instrument_audio
