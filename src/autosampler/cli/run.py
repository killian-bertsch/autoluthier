"""``autosampler run`` — load, process, and export one or more instrument folders.
...
from autosampler.cli._progress import RichProgressSink
...
from autosampler.config.workspace import discover_projects
from autosampler.export.writer import ExportError, ExportResult, export_instrument
...
from autosampler.pipeline.graph import ChainConfigError, build_chain, partition_chain
