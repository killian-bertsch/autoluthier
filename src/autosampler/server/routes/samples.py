...
from autosampler.io.peaks import DEFAULT_BIN_COUNTS, PeakLevel, compute_peaks
from autosampler.io.writer import encode_audio
from autosampler.server.state import (
    AppState,
    AudioSource,
    SampleKind,
    parse_sample_id,
...
def get_peaks(
    ...
    Raises:
        autosampler.server.state.SessionError: mapped to 404 if the requested source isn't
            loaded.
        autosampler.server.state.SampleNotFoundError: mapped to 404 if the id doesn't match
            a loaded sample.
    """
