...
from autosampler.export.writer import plan_export
from autosampler.pipeline.executor import RunResult, run_chain
from autosampler.pipeline.graph import build_chain
from autosampler.pipeline.preview import copy_instrument_audio
...
def get_sfz_preview(request: Request) -> SfzPreview:
    ...
    Raises:
        ...
        autosampler.export.writer.ExportError: mapped to 400 if selection leaves nothing to
            export.
