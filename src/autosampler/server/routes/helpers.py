...
from autosampler.helpers.concat_layers import DEFAULT_LAYER_NUMBERS, concat_layers
from autosampler.helpers.concat_layers import TARGET_DB_DEFAULT as CONCAT_TARGET_DB_DEFAULT
from autosampler.helpers.midi_session import MidiSessionResult, generate_midi_session
from autosampler.helpers.prenormalize import TARGET_DB_DEFAULT as PRENORM_TARGET_DB_DEFAULT
from autosampler.helpers.prenormalize import prenormalize_sources
...
def midi_session(body: MidiSessionRequest) -> MidiSessionResponse:
    """Generate an autosampler MIDI session plus its project.toml.
