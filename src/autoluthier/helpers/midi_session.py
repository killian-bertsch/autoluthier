"""Generates an autoluthier MIDI session plus a matching ``project.toml`` skeleton.
...
from autoluthier.domain.notes import midi_to_note_name, recorded_notes, velocity_list
