...
from autoluthier.config.toml_io import PROJECT_FILENAME, TomlParseError, read_toml, write_toml
...
def default_workspace_path() -> Path:
    ...
    ``~/.autoluthier/workspace.toml`` — outside any project folder, since the index tracks
    ...
    """
    return Path.home() / ".autoluthier" / "workspace.toml"
